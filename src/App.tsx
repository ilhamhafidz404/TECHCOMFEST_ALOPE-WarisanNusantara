    ...
    <>
      ...
      <Router>
        <nav className="fixed left-0 right-0 bg-transparent z-50 text-black py-10 px-24 transition-all duration-500">
          <section className="flex justify-between">
            <div className="w-1/2">
              <h2 className="font-bold text-2xl font-dancing-script w-full">
                Indonesia Culture
              </h2>
            </div>
            <div className="flex gap-10 items-center justify-end w-1/4">
              ...
              >
                <span
                  id="changeMode"
                  className="text-red-500 bg-white hover:text-white hover:bg-red-500 transition-all cursor-pointer  w-[30px] h-[30px] flex items-center justify-center rounded-full"
                >
                  <Switcher />
                </span>
              </BootstrapTooltip>
      ...
      <header className="grid lg:grid-cols-2 relative z-10">
        ...
        <section className="relative p-10 flex lg:flex-col sm:flex-row flex-col lg:items-end items-center lg:justify-end justify-between lg:order-1 order-2 lg:gap-0 gap-10">
          ...
          <div className="lg:w-[70%] sm:w-[60%] w-full sm:order-1 order-2 lg:mb-20 lg:absolute lg:top-1/2 lg:-translate-y-1/2">
            <p
              className="text-sm text-gray-800 lg:text-right text-left"
              data-aos="fade-right"
              data-aos-delay="100"
            >
      ...
      <section className="grid lg:grid-cols-2 lg:px-20 md:px-14 sm:px-12 px-8 gap-28 items-center lg:mt-20 mt-10 relative">
        ...
        <div className="md:text-left text-center ">
          <h2
            className="font-bold sm:text-3xl text-2xl mb-5"
            data-aos="fade-right"
            data-aos-once="true"
          >
      ...
      <section className="grid lg:grid-cols-4 md:grid-cols-2 md:gap-10 gap-5 lg:px-20 md:px-14 sm:px-12 px-8 mt-36 relative">
        ...
        <div className="lg:col-span-4 md:col-span-2">
          <h3
            className="font-bold text-3xl md:text-left text-center"
            data-aos="fade-right"
            data-aos-once="true"
          >
          ...
          <p
            className="text-gray-800 lg:w-2/3 md:w-3/4 w-full md:mx-0 mx-auto md:text-left text-center text-sm mt-5"
            data-aos="fade-right"
            data-aos-delay="300"
            data-aos-once="true"
          >
      ...
      >
        <div className="bg-red-200 py-12 text-center rounded-md px-20">
          ...
          <h3 className="font-bold md:text-3xl text-xl mt-5">
      ...
      <section>
        <div className="grid lg:grid-cols-5 gap-10 items-center lg:px-20 md:px-10 px-5 mt-10">
          ...
          >
            ...
            <p className="text-gray-800 mt-5 md:text-base text-sm">
            ...
            <div className="flex gap-5 md:justify-end justify-center mt-5">
              <button className="flex items-center justify-center rounded-full w-[30px] h-[30px] bg-gray-300 hover:bg-gray-200">
                <FaChevronLeft />
              </button>
              <button className="flex items-center justify-center rounded-full w-[30px] h-[30px] bg-gray-300 hover:bg-gray-200">
                <FaChevronRight />
          ...
          <>
            <section className="lg:grid hidden grid-cols-3 gap-10 px-20 mt-10">
              <div>
                ...
                />
                <h3 className="mt-3 text-xl font-bold">INI JUDUL BERITA</h3>
